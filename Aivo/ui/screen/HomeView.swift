                ...
                ZStack(alignment: .topLeading) {
                    ...
                    Group {
                        if selectedInputType == .description, songDescription.isEmpty {
                            ...
                            Text("Paste or write your lyrics here…")
                                .font(.system(size: 14))
                    ...
                    ForEach(SongMood.getHottest(), id: \.self) { mood in
                        Button(action: {
                            ...
                            Text(mood.displayName)
                                ...
                                .background(
                                    RoundedRectangle(cornerRadius: 8)
                                        .fill(selectedMood == mood ? AivoTheme.Secondary.coralRed : Color.gray.opacity(0.3))
                                )
                        }
                    }
                ...
                HStack(spacing: 12) {
                    ForEach(SongGenre.getHottest(), id: \.self) { genre in
                        Button(action: {
                            ...
                            .background(
                                RoundedRectangle(cornerRadius: 12)
                                    .fill(selectedGenre == genre ? AivoTheme.Primary.orangeDark : Color.gray.opacity(0.3))
                            )
                        }
                    }
                }
